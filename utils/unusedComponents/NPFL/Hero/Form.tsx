...
export default function Form() {
  ...
  const handleSubmit = async (e: any) => {
    ...
    // Check if record already exists on Klaviyo
    try {
            ...
            <div className="flex flex-col gap-5 w-full md:w-3/4 mx-auto">
              ...
              <div className="flex flex-col justify-between items-center">
                ...
                <p className="text-center">
                  *Sponsorless and the NPFL have no official affiliation.
                  Sponsorless independently established an incentive based
                  program specific to the NPFL, upon their own discretion. This
                  program is open for everyone to participate.
                </p>
              </div>
            </div>
          </div>
